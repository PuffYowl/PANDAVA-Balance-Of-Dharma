...
class Mage(BasePlayer):
    ...
    def __init__(self, x, y, assets_folder='assets2/player_mage', scale=3):
        ...
        self.animations = {
            ...
            "idle": load_frames(f"{assets_folder}/Idle", scale=scale),

            "walk": load_frames(f"{assets_folder}/Walk", scale=scale),

            "dash": load_frames(f"{assets_folder}/Dash", scale=scale),

            "attack": load_frames(f"{assets_folder}/Attack", scale=scale),
