...
class Knight(BasePlayer):
    ...
    def __init__(self, x, y, assets_folder='assets2/player_knight', scale=3):
        ...
        self.animations = {
            ...
            "idle": load_spritesheet_row(f"{assets_folder}/Idle.png", 10, scale),
            "walk": load_spritesheet_row(f"{assets_folder}/Walk.png", 10, scale),
            "dash": load_spritesheet_row(f"{assets_folder}/Dash.png", 2, scale),
            "attack": load_spritesheet_row(f"{assets_folder}/Attack.png", 4, scale),
