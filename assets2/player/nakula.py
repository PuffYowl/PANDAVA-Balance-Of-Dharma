...
class Nakula(BasePlayer):
    ...
    def __init__(self, x, y, assets_folder='assets2/player_nakula', scale=4):
    ...
    def update(self):
        ...
        # D ditekan -> facing kanan (1)
        # A ditekan -> facing kiri (-1)
    ...
    def animate(self):
        ...
        # Kondisi flip dibalik (sebelumnya facing==-1, ternyata masih
        # kebalik di game, jadi sekarang facing==1 yang di-flip).
        if self.facing == 1:
