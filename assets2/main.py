...
def tutorial_screen():
    ...
    lines = [
        ...
        ("", False),
        ("KONTROL", True),
        ("  Gerak   :  Joystick kiri", False),
        ("  Serang  :  Tombol ATK", False),
        ("  Dash    :  Tombol DASH", False),
        ("  Ultimate:  Tombol ULT  (semua karakter)", False),
        ("  Interaksi: Tombol USE / ENTER (dekat portal / relic / Resi)", False),
        ("  Jeda    :  Tombol Pause (atas tengah)", False),
        ("", False),
        ("MEKANIK", True),
